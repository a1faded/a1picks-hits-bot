...
top_15_players = df_merged[(df_merged['K_prob'] <= 15) & (df_merged['BB_prob'] <= 15)].sort_values(by='Overall Score', ascending=False).head(5) #14.9 & 15 Paramaters is currently at 70% hit rate , if set to 16 & 17 currecntly at 61.5% rate
